...
/// <summary>
/// Interaction logic for AdjustmentParametersCoordinatesView.xaml
/// </summary>
public partial class AdjustmentParametersCoordinatesView : Page
{
    private AdjustmentParametersCoordinatesViewModel ViewModel;

    public AdjustmentParametersCoordinatesView(AdjustmentParametersCoordinatesViewModel viewModel)
    {
        ViewModel = viewModel;
